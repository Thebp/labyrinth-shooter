...
public class CollisionControlSystemTest {
    ...
    private Object createTestEntity(float x, float y, int life, int damage, Class<? extends Entity> type) {
        Entity e;
        if (type == E1.class)
            e = new E1();
    ...
    public void testEntityProcessing() {
        ...
        Entity entity1 = (Entity)createTestEntity(50, 50, 100, 20, Entity.class);
        Entity entity2 = (Entity)createTestEntity(51, 50, 80, 20, Entity.class);
